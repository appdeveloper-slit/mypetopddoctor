...
class STM {
  ...
  List<BottomNavigationBarItem> getBottomList(index) {
    return [
      ...
      BottomNavigationBarItem(
        icon: SvgPicture.asset(
          "assets/bn_wallet.svg",
        ),
        label: 'My Wallet',
      ),
      BottomNavigationBarItem(
        icon: SvgPicture.asset(
          "assets/bn_patient.svg",
        ),
        label: 'Patient',
      ),
      BottomNavigationBarItem(
  ...
  Widget svgimage(Map<String, dynamic> v){
    return v['url'].toString().contains('assets') ? SvgPicture.asset('${v['url']}') : SvgPicture.network('${v['url']}');
  }
